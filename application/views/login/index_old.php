...
<head>
  <meta charset="utf-8">
    ...
    <title>Hyper Admin - Log in </title>
...
<body class="hold-transition dash-transparent bg-img" style="background-image: url(<?=base_url()?>file_assert/images/bg-2.jpg)" data-overlay="7">
